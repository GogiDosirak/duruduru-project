...
<center>
		...
		<br>
		<center>
			<form action="/updateWach/${walkCheckBoard.wachboSeq}" method="post"
				enctype="multipart/form-data">
				<div class="col-md-8">
					<div class="mb-3 mt-3">
						<label for="productName"></label> <input type="text"
								class="form-control" id="wachboTitle" 
							name="wachboTitle" value="${walkCheckBoard.wachboTitle}")>
					</div>
				</div>
				<div class="col-md-8">
					<div class="mb-3">
						<textarea id="wachboContent" name="wachboContent">${walkCheckBoard.wachboContent}</textarea>
						<script>
							// 파일명을 표시하는 함수
