 ...
 #usboContent {
	...
	<div class="container mt-3">
		...
		<center>
			...
			<br>
			<center>
				<form action="/updateFindPetBoard?fpSeq=${findFPetBoard.fpSeq }" method="post"
					enctype="multipart/form-data">
					<div class="col-md-8">
						<div class="mb-3 mt-3">
							<label for="fpTitle"></label> <input type="text"
								class="form-control" id="fpTitle" value="${findFPetBoard.fpTitle }"
								name="fpTitle">
						</div>
					...
					<div class="col-md-8">
    <div class="mb-3">
        <textarea id="fpContent" name="fpContent">${findFPetBoard.fpContent}</textarea>
        <script>
            // 파일명을 표시하는 함수
