	...
	<div class="col-md-8">
		<div class="mb-3 mt-3">
			<label for="title"></label> <input type="text" class="form-control"
				id="walkReservationTitle" value="${walkReservation.wareTitle}" name="walkReservationTitle">
		</div>
	</div>
...
<input id="wareSeq" type="hidden" value="${walkReservation.wareSeq}">
	...
	<div class="col-md-8">
		<div class="mb-3">
			<label for="walkReservationContent"></label>
			<textarea id="walkReservationContent" >${walkReservation.wareContent}</textarea>
			<script>
				// 파일명을 표시하는 함수
				...
				$(document).ready(
						function() {
							$("#walkReservationContent").summernote({
								height : 500
...
<center>
	<button id="btn-updateWalkReservation" class="btn btn-warning">글수정</button>
</center>
