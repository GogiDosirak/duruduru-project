...
<input type="hidden" id="snsboSeq" name="snsboSeq" value="${snsboSeq }">
<div class="container">
<div class="login-container">
<img id="duruduru-image" src="/images/duruduru.png"
				alt="Duruduru Logo">
				<br><br>
<form id="petForm" action="/updateSns/${snsboSeq}" method="post"
	...
	<div class="form-group">
		<label for="snsboContent">문구 작성</label> <input type="text" id="snsboContent"
			name="snsboContent" value="${sns.snsboContent }" required>
	</div>
	<br>
	<div class="form-group">
