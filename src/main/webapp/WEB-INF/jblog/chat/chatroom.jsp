...
<div id="username-page">
    <div class="username-page-container">
        ...
        <form id="usernameForm" name="usernameForm">
            	<h2>${principal.nickname}님 환영합니다</h2>
                <input type="hidden" id="name" autocomplete="off" class="form-control" value="${principal.nickname}"/>
                <input type="hidden" id="crSeq" autocomplete="off" class="form-control" value="${room.crSeq}"/>
        ...
        <form id="messageForm" name="messageForm" nameForm="messageForm">
            <div class="form-group">
                <div class="input-group clearfix">
                    <input type="text" id="message" placeholder="네세지를 입력해주세요" autocomplete="off"
                           class="form-control"/>
