...
public class ShopController {
	...
	@GetMapping("/updateProduct/{productSeq}") //일단 상품 수정을 누르면 updateProduct.jsp로 보내야하므로 겟매핑 해주고, 누른 상품에 대한 정보를 띄워야 하므로 seq를 기준으로 찾아주고 모델에 저장
	...
	public String updateProduct(@PathVariable int productSeq, Product product, MultipartFile file) throws Exception { //form엔 Post,Get 방식밖에 없으므로 PutMapping을 사용 못하고 Postmapping을 사용하였다.
