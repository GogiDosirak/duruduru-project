...
public class WalkCheckBoardController {
	...
	public String insertProduct(WalkCheckBoard walkCheckBoard, MultipartFile file, HttpSession session) throws Exception { // 매개변수들 추가 후 오류
	...
	public String getWach(Model model, @PathVariable int wachboSeq) {
	...
	public String updateProduct(@PathVariable int wachboSeq, Model model) {
		WalkCheckBoard walkCheckBoard = walkCheckBoardService.getwach(wachboSeq);
		model.addAttribute(walkCheckBoard);
	...
	public String updateProduct(@PathVariable int wachboSeq, WalkCheckBoard walkCheckBoard, MultipartFile file) throws Exception { //form엔 Post,Get 방식밖에 없으므로 PutMapping을 사용 못하고 Postmapping을 사용하였다.
